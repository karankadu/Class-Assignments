//
//  DialedCall-TableViewController.swift
...
class DialedCall_TableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let user:userInfo = dialedCallArray.objectAtIndex(indexPath.row) as! userInfo
