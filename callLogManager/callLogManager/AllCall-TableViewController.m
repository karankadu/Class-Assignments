...
#import "AllCall-TableViewController.h"
#import "customTableViewCell.h"
#import "userInfo.h"

@interface AllCall_TableViewController ()

@end

@implementation AllCall_TableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
   // _allCallArray=[[NSMutableArray alloc]init];
    ...
    _allCallArray=[[NSMutableArray alloc]initWithObjects:u1,u2,u3,u4,u2,u1,u3,nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    userInfo *tempUser=[_allCallArray objectAtIndex:indexPath.row];
