//
//  ReceivedCall-TableViewController.m
//  callLogManager
//
...
#import "ReceivedCall-TableViewController.h"
#import "customTableViewCell.h"
#import "userInfo.h"

@interface ReceivedCall_TableViewController ()

@end

@implementation ReceivedCall_TableViewController
...
- (void)viewDidLoad {
    ...
    _receivedCallArray=[[NSMutableArray alloc]initWithObjects:u2,u1,u4,u3,nil];
...
//#warning Incomplete implementation, return the number of rows
    return _receivedCallArray.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    userInfo *tempUser=[_receivedCallArray objectAtIndex:indexPath.row];
